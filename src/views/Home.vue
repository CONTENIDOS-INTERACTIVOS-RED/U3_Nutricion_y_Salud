          ...
          .row.g-0
            ...
            .col-xl-6.info-section
              .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
                ...
                p.descripcion.mb-4 La unidad destaca la importancia de los hábitos y entornos saludables como pilares fundamentales para el bienestar físico, mental y social de los niños. Desde una alimentación balanceada y la práctica de actividades físicas, hasta la creación de entornos seguros y la promoción de revisiones médicas periódicas, se profundiza en cómo estas acciones impactan el desarrollo integral de la infancia. Asimismo, se abordan temas como la agricultura local, la preparación de multimezclas, la prevención de enfermedades y los beneficios de la lactancia materna, ofreciendo herramientas prácticas para mejorar la nutrición infantil.
                
                p #[b ¡Prepárese para aplicar estrategias efectivas que promuevan el bienestar y el desarrollo saludable en la infancia!]
